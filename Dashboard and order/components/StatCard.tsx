...
const StatCard: React.FC<StatCardProps> = ({ title, value, icon, iconBg, iconColor }) => {
  return (
    <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:border-primary transition-all flex flex-col justify-between group">
