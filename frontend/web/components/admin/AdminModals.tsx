...
export const AdminModals: React.FC<AdminModalsProps> = ({ modal, onClose, onSave, onDelete, existingUsers = [] }) => {
  ...
  const validateForm = (): FormErrors => {
    ...
    if (formData.dob) {
      ...
      if (age < 13) {
        errors.dob = 'Người dùng phải từ 13 tuổi trở lên';
      }
    }
  ...
  const errors = useMemo(() => validateForm(), [formData]);
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-3 gap-4 border-b border-gray-100 pb-4">
                 ...
                 <span className="text-sm font-medium text-gray-900 col-span-2">
                   {modal.data.dob ? new Date(modal.data.dob).toLocaleDateString('vi-VN') : 'Chưa cập nhật'}
                 </span>
              </div>
              <div className="grid grid-cols-3 gap-4 border-b border-gray-100 pb-4">
              ...
              <div className="grid grid-cols-3 gap-4 border-b border-gray-100 pb-4">
                 ...
                 <span className="text-sm font-medium text-gray-900 col-span-2">{new Date(modal.data.joinDate).toLocaleDateString('vi-VN')}</span>
              </div>
