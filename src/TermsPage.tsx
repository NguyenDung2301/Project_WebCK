...
export const TermsPage: React.FC<TermsPageProps> = ({ onBack, onHome }) => {
  return (
    <div className="min-h-screen bg-white px-4 pt-28 pb-10 font-sans relative">
      {/* Global Logo */}
      ...
      <div className="max-w-[800px] mx-auto bg-white rounded-[40px] shadow-sm p-8 sm:p-12 relative border border-gray-100">
